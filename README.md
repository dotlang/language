...
01. `#`   Comment
02. `.`   Access struct/module members
...
The result of importing a module is a module definition which should be pascal named and can be used with dot notation to access definitons inside module.
