...
12. `:`   type declaration for struct and function input and values, custom literals, type alias
...
16. `_`   placeholder (lambda creator, unknown variable in assignments or function argument)
17. `.{}` casting
