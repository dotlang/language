...
{
  "$end", "error", "$undefined", "NUMBER", "OPERATOR", "$accept", "EXPR", YY_NULLPTR
};
#endif
...
#line 21 "parser.y" /* yacc.c:1646  */
    { cout << "bison found triple: " << (yyvsp[-2]) << (yyvsp[-1]) << (yyvsp[0]) << endl; }
#line 1199 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 23 "parser.y" /* yacc.c:1646  */
    { cout << "bison found triple: " << (yyvsp[-3]) << (yyvsp[-2]) << (yyvsp[-1]) << endl; }
