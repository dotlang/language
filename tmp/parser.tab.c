...
{
  "$end", "error", "$undefined", "ENDL", "EQ", "IDENTIFIER", "NUMBER",
  "OPERATOR", "$accept", "PROGRAM", "LINE", "primary_expression",
...
{
      -4,    12,     1,     2,    14,     1,     2,    11,     2,     7,
       8,    10,    13,     0,     0,     9
};

static const yytype_int8 yycheck[] =
{
       3,     7,     5,     6,    10,     5,     6,     5,     6,     4,
       0,     7,     3,    -1,    -1,     4
};
...
#line 43 "../parser.y" /* yacc.c:1646  */
    {
                ...
                ht_set(symtable, (yyvsp[-2].sval), value);


                void* xvalue = ht_get(symtable, (yyvsp[-2].sval));
                if ( xvalue == NULL ) {
                    printf("WOWCannot find symbol %s", (yyvsp[-2].sval));
                    exit(-1);
                }
                printf("value of %s is %d\n", (yyvsp[-2].sval), *(int*)xvalue); 
            }
...
#line 66 "../parser.y" /* yacc.c:1646  */
    {
                ...
                if ( value == NULL ) {
                    printf("Cannot find symbol %s", (yyvsp[0].sval));
                    exit(-1);
                }

                (yyval.ival) = *(int*)value;
